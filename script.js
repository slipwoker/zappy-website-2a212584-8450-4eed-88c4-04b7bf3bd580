document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field) {
      ...
      if (name.includes('email') || type === 'email') return errorMessages.email;
      if (name.includes('name'))                        return errorMessages.name;
      if (name.includes('message') || field.tagName.toLowerCase() === 'textarea') return errorMessages.message;
      if (name.includes('phone') || type === 'tel')     return errorMessages.phone;
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Optionally add success class for CSS feedback
  ...
  const STAGGER_DELAY      = 100; // ms per sibling

  function initScrollAnimations() {
    const elements = document.querySelectorAll(
      '[data-animate], .animate-on-scroll, .fade-in, .fade-in-up, .fade-in-left, .fade-in-right'
    );
    ...
    // Add base animation class if not already set
    elements.forEach(function (el, index) {
      if (!el.hasAttribute(ANIMATION_ATTR)) {
        el.setAttribute(ANIMATION_ATTR, ANIMATION_CLASS);
      }

      // Stagger siblings with same parent
      const siblings = Array.from(el.parentElement.children).filter(function (child) {
        return child.hasAttribute(ANIMATION_ATTR) ||
      ...
      if (siblingIndex > 0 && !el.style.transitionDelay) {
        el.style.transitionDelay = (siblingIndex * STAGGER_DELAY) + 'ms';
      }
    });
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
      ...
      "es": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור utiliza cookies para mejorar tu experiencia, analizar el uso del sitio y ayudar en nuestros esfuerzos de marketing.",
      ...
      "fr": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור utilise des cookies pour améliorer votre expérience, analyser l'utilisation du site et nous aider dans nos efforts marketing.",
      ...
      "de": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור verwendet Cookies, um Ihr Erlebnis zu verbessern, die Nutzung der Website zu analysieren und unsere Marketingbemühungen zu unterstützen.",
      ...
      "it": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור utilizza i cookie per migliorare la tua esperienza, analizzare l'utilizzo del sito e supportare le nostre attività di marketing.",
      ...
      "pt": {
        "consentModal": {
          "title": "Usamos cookies 🍪",
          "description": "מרכז מבינים זוגיות - ליאור גור usa cookies para melhorar sua experiência, analisar o uso do site e auxiliar em nossos esforços de marketing.",
      ...
      "nl": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור gebruikt cookies om uw ervaring te verbeteren, het sitegebruik te analyseren en onze marketinginspanningen te ondersteunen.",
      ...
      "he": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
      ...
      "ar": {
        "consentModal": {
          ...
          "description": "يستخدم מרכז מבינים זוגיות - ליאור גור ملفات تعريف الارتباط لتحسين تجربتك وتحليل استخدام الموقع والمساعدة في جهودنا التسويقية.",
      ...
      "tr": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור, deneyiminizi geliştirmek, site kullanımını analiz etmek ve pazarlama çalışmalarımıza yardımcı olmak için çerezler kullanır.",
      ...
      "ru": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור использует файлы cookie для улучшения вашего опыта, анализа использования сайта и поддержки наших маркетинговых усилий.",
      ...
      "zh": {
        "consentModal": {
          "title": "我们使用 Cookie 🍪",
          "description": "מרכז מבינים זוגיות - ליאור גור 使用 Cookie 来改善您的体验、分析网站使用情况并协助我们的营销工作。",
          "acceptAllBtn": "全部接受",
      ...
      "ja": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גורは、お客様の体験向上、サイト利用状況の分析、マーケティング活動の支援のためにCookieを使用しています。",
          "acceptAllBtn": "すべて許可",
      ...
      "ko": {
        "consentModal": {
          "title": "쿠키를 사용합니다 🍪",
          "description": "מרכז מבינים זוגיות - ליאור גור은(는) 경험 향상, 사이트 사용 분석 및 마케팅 활동 지원을 위해 쿠키를 사용합니다.",
          "acceptAllBtn": "모두 수락",
      ...
      "pl": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור używa plików cookie, aby poprawić Twoje wrażenia, analizować korzystanie z witryny i wspierać nasze działania marketingowe.",
      ...
      "uk": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור використовує файли cookie для покращення вашого досвіду, аналізу використання сайту та підтримки наших маркетингових зусиль.",
      ...
      "ro": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור folosește cookie-uri pentru a vă îmbunătăți experiența, a analiza utilizarea site-ului și a sprijini eforturile noastre de marketing.",
      ...
      "bg": {
        "consentModal": {
          ...
          "description": "מרכז מבינים זוגיות - ליאור גור използва бисквитки, за да подобри вашето изживяване, да анализира използването на сайта и да подпомогне маркетинговите ни усилия.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2a212584-8450-4eed-88c4-04b7bf3bd580',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2a212584-8450-4eed-88c4-04b7bf3bd580';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2a212584-8450-4eed-88c4-04b7bf3bd580';
